    ...
    <Popover.Root>
      <Popover.Trigger
        className={clsx("w-10 h-10 border-2  rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-violet-600 focus:ring-offset-2 focus:ring-offset-background", {
          ...
          "bg-violet-500 border-violet-400": progress > 0 && progress < 20,
          "bg-violet-600 border-violet-500": progress >= 20 && progress < 40,
          "bg-violet-700 border-violet-600": progress >= 40 && progress < 60,
          "bg-violet-800 border-violet-700": progress >= 60 && progress < 80,
          "bg-violet-900 border-violet-800": progress >= 80,
        })}
      />
      <Popover.Portal>
